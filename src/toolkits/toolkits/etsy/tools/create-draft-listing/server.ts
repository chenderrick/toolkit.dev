    ...
    callback: async ({
      ...
      try {
        ...
        const params: ICreateDraftListingPayload = {
          ...
          ...(item_dimensions_unit !== undefined ? {item_dimensions_unit} : {}),
          ...(is_personalizable !== undefined ? {is_personalizable} : {}),
          ...(personalization_is_required !== undefined ? {personalization_is_required} : {}),
          ...(personalization_char_count_max !== undefined ? {personalization_char_count_max} : {}),
          ...(personalization_instructions !== undefined ? {personalization_instructions} : {}),
          ...(production_partner_ids !== undefined ? {production_partner_ids} : {}),
